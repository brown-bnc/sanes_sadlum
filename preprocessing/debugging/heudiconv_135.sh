...
#SBATCH -c 2
#SBATCH -J heudiconv
#SBATCH -o /gpfs/scratch/%u/logs/heudiconv-%A_%a.out
#SBATCH --array=135
...
# Output directory
input_dir=${data_dir}/shared/bids-export/mrestrep/sanes/study-sadlum/xnat-export
output_dir=/gpfs/scratch/${USER}/bids/
...
singularity exec -B ${input_dir}:/input:ro -B ${output_dir}:/output ${simg} \
    heudiconv -f reproin --bids  -o /output \
    --dicom_dir_template /input/sub-{subject}/ses-{session}/*/*.IMA  --subjects 135 --ses 01